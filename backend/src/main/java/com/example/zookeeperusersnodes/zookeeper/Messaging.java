...
//import com.example.zookeeperusersnodes.zookeeper.impl.WatchersManagerImpl;
...
//
//@Component
//public class Messaging implements Watcher {
//    private final ZooKeeper zooKeeper;
//
//    private final WatchersManager watcherManager;
//    private final MessageService messageService;
//
//    public Messaging(ZooKeeperInitializer zooKeeperInitializer, WatchersManager watcherManager, MessageService messageService) {
...
//                zooKeeper.addWatch(childPath, new MessageWatcher(this.zooKeeper), AddWatchMode.PERSISTENT);
